...
{
    public partial class uscBaoCaoChartLoiNhuanThang : UserControl
    {
        public uscBaoCaoChartLoiNhuanThang()
        {
            InitializeComponent();
        }
        ...
        void LoadData()
        {
            ...
            chartControl1.DataSource = db.BaoCaoChartLoiNhuanThang_Select(nam);
