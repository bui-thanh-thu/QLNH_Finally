...
{
    public partial class uscBaoCaoContentLoiNhuan : UserControl
    {
        public uscBaoCaoContentLoiNhuan()
        {
            InitializeComponent();
        ...
        void LoadData()
        {
            ...
            grBCThang.Controls.Add(new uscBaoCaoChartLoiNhuanThang() { Dock = DockStyle.Fill });
            //grBCQuy.Controls.Add(new uscBaoCaoChartQuy() { Dock = DockStyle.Fill });
            grBCNam.Controls.Add(new uscBaoCaoChartLoiNhuanNam() { Dock = DockStyle.Fill });
        }
